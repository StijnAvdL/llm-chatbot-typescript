...
export async function getHistory(
  ...
  // Execute the Cypher statement from /cypher/get-history.cypher in a read transaction
...
export async function saveHistory(
  ...
  // Execute the Cypher statement from /cypher/save-response.cypher in a write transaction
  const graph = await initGraph();
